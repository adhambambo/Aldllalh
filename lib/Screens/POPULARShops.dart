...
class popularshops extends StatefulWidget {
  const popularshops({super.key});

  @override
  State<popularshops> createState() => _popularshopsState();
}

class _popularshopsState extends State<popularshops> {
  final Stream<QuerySnapshot> AbayatKerdasa = FirebaseFirestore.instance
      .collection('populars/popular shops/popularshops')
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() =>
                          popshpobannersInfo(factoryDatatwo: factoryData));
                    },
                    child: Image.network(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => popularshopinfo(factoryData: factoryData));
                    },
...
//
class popularshopinfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const popularshopinfo({Key? key, required this.factoryData});

  @override
  State<popularshopinfo> createState() => _popularshopinfoState();
}

class _popularshopinfoState extends State<popularshopinfo> {
...
class popshpobannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  popshpobannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<popshpobannersInfo> createState() => _popshpobannersInfoState();
}

class _popshpobannersInfoState extends State<popshpobannersInfo> {
