...
class popularFactory extends StatefulWidget {
  const popularFactory({super.key});

  @override
  State<popularFactory> createState() => _popularFactoryState();
}

class _popularFactoryState extends State<popularFactory> {
  final Stream<QuerySnapshot> AbayatKerdasa = FirebaseFirestore.instance
      .collection('populars/popular factories/popularfactory')
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(
                          () => popfacbannersInfo(factoryDatatwo: factoryData));
                    },
                    child: Image.network(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(
                          () => popularfactoryinfo(factoryData: factoryData));
                    },
...
//
class popularfactoryinfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const popularfactoryinfo({Key? key, required this.factoryData});

  @override
  State<popularfactoryinfo> createState() => _popularfactoryinfoState();
}

class _popularfactoryinfoState extends State<popularfactoryinfo> {
...
class popfacbannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  popfacbannersInfo({Key? key, required this.factoryDatatwo}) : super(key: key);

  @override
  State<popfacbannersInfo> createState() => _popfacbannersInfoState();
}

class _popfacbannersInfoState extends State<popfacbannersInfo> {
