...
class lapijamakids extends StatefulWidget {
  const lapijamakids({super.key});

  @override
  State<lapijamakids> createState() => _lapijamakidsState();
}

class _lapijamakidsState extends State<lapijamakids> {
  final Stream<QuerySnapshot> AbayatKerdasa = FirebaseFirestore.instance
      .collection('populars/exhibtions/lapijamakids')
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() =>
                          lapijamakidsbannersInfo(factoryDatatwo: factoryData));
                    },
                    child: Image.network(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => lapijamakidsinfo(factoryData: factoryData));
                    },
...
//
class lapijamakidsinfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const lapijamakidsinfo({Key? key, required this.factoryData});

  @override
  State<lapijamakidsinfo> createState() => _lapijamakidsinfoState();
}

class _lapijamakidsinfoState extends State<lapijamakidsinfo> {
...
class lapijamakidsbannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  lapijamakidsbannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<lapijamakidsbannersInfo> createState() => _lapijamakidsbannersInfoState();
}

class _lapijamakidsbannersInfoState extends State<lapijamakidsbannersInfo> {
