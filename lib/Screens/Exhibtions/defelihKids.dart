...
class defilihKids extends StatefulWidget {
  const defilihKids({super.key});

  @override
  State<defilihKids> createState() => _defilihKidsState();
}

class _defilihKidsState extends State<defilihKids> {
  final Stream<QuerySnapshot> AbayatKerdasa = FirebaseFirestore.instance
      .collection('populars/exhibtions/dfilihkids')
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() =>
                          defilihKidsbannersInfo(factoryDatatwo: factoryData));
                    },
                    child: Image.network(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => defilihKidsinfo(factoryData: factoryData));
                    },
...
//
class defilihKidsinfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const defilihKidsinfo({Key? key, required this.factoryData});

  @override
  State<defilihKidsinfo> createState() => _defilihKidsinfoState();
}

class _defilihKidsinfoState extends State<defilihKidsinfo> {
...
class defilihKidsbannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  defilihKidsbannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<defilihKidsbannersInfo> createState() => _defilihKidsbannersInfoState();
}

class _defilihKidsbannersInfoState extends State<defilihKidsbannersInfo> {
