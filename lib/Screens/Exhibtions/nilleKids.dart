...
class nilikids extends StatefulWidget {
  const nilikids({super.key});

  @override
  State<nilikids> createState() => _nilikidsState();
}

class _nilikidsState extends State<nilikids> {
  final Stream<QuerySnapshot> AbayatKerdasa = FirebaseFirestore.instance
      .collection('populars/exhibtions/nilikids')
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() =>
                          nilikidsbannersInfo(factoryDatatwo: factoryData));
                    },
                    child: Image.network(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => nilikidsinfo(factoryData: factoryData));
                    },
...
//
class nilikidsinfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const nilikidsinfo({Key? key, required this.factoryData});

  @override
  State<nilikidsinfo> createState() => _nilikidsinfoState();
}

class _nilikidsinfoState extends State<nilikidsinfo> {
...
class nilikidsbannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  nilikidsbannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<nilikidsbannersInfo> createState() => _nilikidsbannersInfoState();
}

class _nilikidsbannersInfoState extends State<nilikidsbannersInfo> {
