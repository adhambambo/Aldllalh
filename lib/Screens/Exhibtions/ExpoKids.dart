...
class expokids extends StatefulWidget {
  const expokids({super.key});

  @override
  State<expokids> createState() => _expokidsState();
}

class _expokidsState extends State<expokids> {
  final Stream<QuerySnapshot> AbayatKerdasa = FirebaseFirestore.instance
      .collection('populars/exhibtions/expokids')
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() =>
                          expokidsbannersInfo(factoryDatatwo: factoryData));
                    },
                    child: Image.network(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => expokidsinfo(factoryData: factoryData));
                    },
...
//
class expokidsinfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const expokidsinfo({Key? key, required this.factoryData});

  @override
  State<expokidsinfo> createState() => _expokidsinfoState();
}

class _expokidsinfoState extends State<expokidsinfo> {
...
class expokidsbannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  expokidsbannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<expokidsbannersInfo> createState() => _expokidsbannersInfoState();
}

class _expokidsbannersInfoState extends State<expokidsbannersInfo> {
