...
class AgaMansouraTrico extends StatelessWidget {
  AgaMansouraTrico({super.key});
  final Stream<QuerySnapshot> kochi = FirebaseFirestore.instance
      .collection('مصانع/تريكو/مصانع اجا المنصورة')
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() =>
                          ajamasouraabannersInfo(factoryDatatwo: factoryData));
                    },
                    child: Image.network(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(
                          () => ajamansouraFacInfo(factoryData: factoryData));
                    },
...
//
class ajamansouraFacInfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const ajamansouraFacInfo({Key? key, required this.factoryData});

  @override
  State<ajamansouraFacInfo> createState() => _ajamansouraFacInfoState();
}

class _ajamansouraFacInfoState extends State<ajamansouraFacInfo> {
...
class ajamasouraabannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  ajamasouraabannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<ajamasouraabannersInfo> createState() => _ajamasouraabannersInfoState();
}

class _ajamasouraabannersInfoState extends State<ajamasouraabannersInfo> {
