...
class TanamalTrico extends StatelessWidget {
  TanamalTrico({super.key});
  final Stream<QuerySnapshot> kochi = FirebaseFirestore.instance
      .collection('مصانع/تريكو/مصانع طنامل')
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() =>
                          tananamlbannersInfo(factoryDatatwo: factoryData));
                    },
                    child: Image.network(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(
                          () => tanamaliShoesFacInfo(factoryData: factoryData));
                    },
...
//
class tanamaliShoesFacInfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const tanamaliShoesFacInfo({Key? key, required this.factoryData});

  @override
  State<tanamaliShoesFacInfo> createState() => _tanamaliShoesFacInfoState();
}

class _tanamaliShoesFacInfoState extends State<tanamaliShoesFacInfo> {
...
class tananamlbannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  tananamlbannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<tananamlbannersInfo> createState() => _tananamlbannersInfoState();
}

class _tananamlbannersInfoState extends State<tananamlbannersInfo> {
