...
class BlanketsBeddingFurnishing extends StatelessWidget {
  BlanketsBeddingFurnishing({super.key});
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('مصانع/مفروشات ووبريات/بطاطين ودفايات')
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() =>
                          blanketbannersInfo(factoryDatatwo: factoryData));
                    },
                    child: Image.network(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(
                          () => BlankeClothingeiinfo(factoryData: factoryData));
                    },
...
//const
class BlankeClothingeiinfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  BlankeClothingeiinfo({Key? key, required this.factoryData});

  @override
  State<BlankeClothingeiinfo> createState() => _BlankeClothingeiinfoState();
}

class _BlankeClothingeiinfoState extends State<BlankeClothingeiinfo> {
  int _current = 0;
  late int viewsCount;
...
class blanketbannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  blanketbannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<blanketbannersInfo> createState() => _blanketbannersInfoState();
}

class _blanketbannersInfoState extends State<blanketbannersInfo> {
