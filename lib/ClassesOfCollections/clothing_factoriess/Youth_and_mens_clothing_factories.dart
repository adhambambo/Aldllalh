...
class YouthAndMenClothingFactories extends StatefulWidget {
  YouthAndMenClothingFactories({super.key});

  @override
  State<YouthAndMenClothingFactories> createState() =>
      _YouthAndMenClothingFactoriesState();
}

class _YouthAndMenClothingFactoriesState
    extends State<YouthAndMenClothingFactories> {
  final Stream<QuerySnapshot> youthMenClothingFactories = FirebaseFirestore
      .instance
      .collection('مصانع/مصانع ملابس/مصانع ملابس شبابي ورجالي')
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('مصانع ملابس شبابي ورجالي'),
      ),
      body: Container(
        child: StreamBuilder(
          stream: youthMenClothingFactories,
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => touthandmensfacbannersInfo(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(
                          () => youthandmenfacInfo(factoryData: factoryData));
                    },
...
//
class youthandmenfacInfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;
  const youthandmenfacInfo({Key? key, required this.factoryData});
  @override
  State<youthandmenfacInfo> createState() => _youthandmenfacInfoState();
}

class _youthandmenfacInfoState extends State<youthandmenfacInfo> {
  final Stream<QuerySnapshot> youthandmenInfo = FirebaseFirestore.instance
      .collection('مصانع/مصانع ملابس/مصانع ملابس شبابي ورجالي')
      .snapshots();
...
class touthandmensfacbannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  touthandmensfacbannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<touthandmensfacbannersInfo> createState() =>
      _touthandmensfacbannersInfoState();
}

class _touthandmensfacbannersInfoState
    extends State<touthandmensfacbannersInfo> {
