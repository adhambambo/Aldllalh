...
class othersClothingFactories extends StatefulWidget {
  const othersClothingFactories({super.key});

  @override
  State<othersClothingFactories> createState() =>
      _othersClothingFactoriesState();
}

class _othersClothingFactoriesState extends State<othersClothingFactories> {
  final Stream<QuerySnapshot> obourclothingFactories = FirebaseFirestore
      .instance
      .collection('مصانع/مصانع ملابس/مصانع ملابس اخري')
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() =>
                          othersfacbannersInfo(factoryDatatwo: factoryData));
                    },
                    child: Image.network(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => othersFacInfo(factoryData: factoryData));
                    },
...
//
class othersFacInfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const othersFacInfo({Key? key, required this.factoryData});

  @override
  State<othersFacInfo> createState() => _othersFacInfoState();
}

class _othersFacInfoState extends State<othersFacInfo> {
...
class othersfacbannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  othersfacbannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<othersfacbannersInfo> createState() => _othersfacbannersInfoState();
}

class _othersfacbannersInfoState extends State<othersfacbannersInfo> {
