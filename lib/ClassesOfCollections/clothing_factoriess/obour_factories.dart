...
class ObourCityClothingFactories extends StatefulWidget {
  const ObourCityClothingFactories({super.key});

  @override
  State<ObourCityClothingFactories> createState() =>
      _ObourCityClothingFactoriesState();
}

class _ObourCityClothingFactoriesState
    extends State<ObourCityClothingFactories> {
  final Stream<QuerySnapshot> obourclothingFactories = FirebaseFirestore
      .instance
      .collection('مصانع/مصانع ملابس/مصانع ملابس مدينة العبور')
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('مصانع ملابس مدينة العبور'),
      ),
      body: Container(
        child: StreamBuilder(
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(
                          () => obourbannersInfo(factoryDatatwo: factoryData));
                    },
                    child: Image.network(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => obourFacInfo(factoryData: factoryData));
                    },
...
//
class obourFacInfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const obourFacInfo({Key? key, required this.factoryData});

  @override
  State<obourFacInfo> createState() => _obourFacInfoState();
}

class _obourFacInfoState extends State<obourFacInfo> {
...
class obourbannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  obourbannersInfo({Key? key, required this.factoryDatatwo}) : super(key: key);

  @override
  State<obourbannersInfo> createState() => _obourbannersInfoState();
}

class _obourbannersInfoState extends State<obourbannersInfo> {
