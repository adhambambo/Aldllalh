...
class WomensCasualssClothingFactories extends StatefulWidget {
  WomensCasualssClothingFactories({super.key});

  @override
  State<WomensCasualssClothingFactories> createState() =>
      _WomensCasualssClothingFactoriesState();
}

class _WomensCasualssClothingFactoriesState
    extends State<WomensCasualssClothingFactories> {
  final Stream<QuerySnapshot> womensCasualFactories = FirebaseFirestore.instance
      .collection('مصانع/مصانع ملابس/مصانع ملابس كاجوال حريمي')
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('مصانع ملابس كاجوال حريمي'),
      ),
      body: Container(
        child: StreamBuilder(
          stream: womensCasualFactories,
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() =>
                          womenscasulabannersInfo(factoryDatatwo: factoryData));
                    },
                    child: Image.network(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(
                          () => womenscasualfacInfo(factoryData: factoryData));
                    },
...
//
class womenscasualfacInfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const womenscasualfacInfo({Key? key, required this.factoryData});

  @override
  State<womenscasualfacInfo> createState() => _womenscasualfacInfoState();
}

class _womenscasualfacInfoState extends State<womenscasualfacInfo> {
  final Stream<QuerySnapshot> womenscasualinfo = FirebaseFirestore.instance
      .collection('مصانع/مصانع ملابس/مصانع ملابس كاجوال حريمي')
      .snapshots();
...
class womenscasulabannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  womenscasulabannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<womenscasulabannersInfo> createState() =>
      _womenscasulabannersInfoState();
}

class _womenscasulabannersInfoState extends State<womenscasulabannersInfo> {
