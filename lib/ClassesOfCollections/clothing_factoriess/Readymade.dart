...
class readyMadeClothingFac extends StatefulWidget {
  const readyMadeClothingFac({super.key});

  @override
  State<readyMadeClothingFac> createState() =>
      _readyMadeClothingFacState();
}

class _readyMadeClothingFacState extends State<readyMadeClothingFac> {
  final Stream<QuerySnapshot> obourclothingFactories = FirebaseFirestore
      .instance
      .collection('مصانع/مصانع ملابس/مصانع ملابس جاهزة')
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() =>
                          readyMadeClothingFacbanner(factoryDatatwo: factoryData));
                    },
                    child: Image.network(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => readyMadeClothingFacinfo(factoryData: factoryData));
                    },
...
//
class readyMadeClothingFacinfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const readyMadeClothingFacinfo({Key? key, required this.factoryData});

  @override
  State<readyMadeClothingFacinfo> createState() => _readyMadeClothingFacinfoState();
}

class _readyMadeClothingFacinfoState extends State<readyMadeClothingFacinfo> {
...
class readyMadeClothingFacbanner extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  readyMadeClothingFacbanner({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<readyMadeClothingFacbanner> createState() => _readyMadeClothingFacbannerState();
}

class _readyMadeClothingFacbannerState extends State<readyMadeClothingFacbanner> {
