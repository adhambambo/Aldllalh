...
class SkirtHegabClothingFactories extends StatefulWidget {
  const SkirtHegabClothingFactories({super.key});

  @override
  State<SkirtHegabClothingFactories> createState() =>
      _SkirtHegabClothingFactoriesState();
}

class _SkirtHegabClothingFactoriesState
    extends State<SkirtHegabClothingFactories> {
  final Stream<QuerySnapshot> SkirtFactories = FirebaseFirestore.instance
      .collection('مصانع/مصانع ملابس/مصانع طرح ومكملات حجاب')
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('مصانع طرح ومكملات حجاب'),
      ),
      body: Container(
        child: StreamBuilder(
          stream: SkirtFactories,
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() =>
                          SkirtfacbannersInfo(factoryDatatwo: factoryData));
                    },
                    child: Image.network(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => skirtfacinfo(factoryData: factoryData));
                    },
...
//
class skirtfacinfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const skirtfacinfo({Key? key, required this.factoryData});

  @override
  State<skirtfacinfo> createState() => _skirtfacinfoState();
}

class _skirtfacinfoState extends State<skirtfacinfo> {
  final Stream<QuerySnapshot> skirtinfo = FirebaseFirestore.instance
      .collection('مصانع/مصانع ملابس/مصانع طرح ومكملات حجاب')
      .snapshots();
...
class SkirtfacbannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  SkirtfacbannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<SkirtfacbannersInfo> createState() => _SkirtfacbannersInfoState();
}

class _SkirtfacbannersInfoState extends State<SkirtfacbannersInfo> {
