...
class GesrElsuezClothingFactories extends StatefulWidget {
  GesrElsuezClothingFactories({super.key});

  @override
  State<GesrElsuezClothingFactories> createState() =>
      _GesrElsuezClothingFactoriesState();
}

class _GesrElsuezClothingFactoriesState
    extends State<GesrElsuezClothingFactories> {
  final Stream<QuerySnapshot> GesrSuezClothingFactories = FirebaseFirestore
      .instance
      .collection('مصانع/مصانع ملابس/مصانع ملابس جسر السويس')
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('مصانع ملابس جسر السويس'),
      ),
      body: Container(
        child: StreamBuilder(
          stream: GesrSuezClothingFactories,
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(
                          () => SuezbannersInfo(factoryDatatwo: factoryData));
                    },
                    child: Image.network(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => GesrSuezfacInfo(factoryData: factoryData));
                    },
...
//
class GesrSuezfacInfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  GesrSuezfacInfo({Key? key, required this.factoryData});

  @override
  State<GesrSuezfacInfo> createState() => _GesrSuezfacInfoState();
}

class _GesrSuezfacInfoState extends State<GesrSuezfacInfo> {
  final Stream<QuerySnapshot> gesrSuezInfo = FirebaseFirestore.instance
      .collection('مصانع/مصانع ملابس/مصانع ملابس جسر السويس')
      .snapshots();
...
class SuezbannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  SuezbannersInfo({Key? key, required this.factoryDatatwo}) : super(key: key);

  @override
  State<SuezbannersInfo> createState() => _SuezbannersInfoState();
}

class _SuezbannersInfoState extends State<SuezbannersInfo> {
