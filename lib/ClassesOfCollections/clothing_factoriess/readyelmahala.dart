...
class readyMadeelmhalaClothingFac extends StatefulWidget {
  const readyMadeelmhalaClothingFac({super.key});

  @override
  State<readyMadeelmhalaClothingFac> createState() =>
      _readyMadeelmhalaClothingFacState();
}

class _readyMadeelmhalaClothingFacState extends State<readyMadeelmhalaClothingFac> {
  final Stream<QuerySnapshot> obourclothingFactories = FirebaseFirestore
      .instance
      .collection('مصانع/مصانع ملابس/مصانع ملابس جاهزة المحله الكبري')
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('مصانع ملابس جاهزة المحله '),
      ),
      body: Container(
        child: StreamBuilder(
          stream: obourclothingFactories,
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() =>
                          readyMadeelmhalaClothingFacbanner(factoryDatatwo: factoryData));
                    },
                    child: Image.network(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => readyMadeelmhalaClothingFacinfo(factoryData: factoryData));
                    },
...
//
class readyMadeelmhalaClothingFacinfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const readyMadeelmhalaClothingFacinfo({Key? key, required this.factoryData});

  @override
  State<readyMadeelmhalaClothingFacinfo> createState() => _readyMadeelmhalaClothingFacinfoState();
}

class _readyMadeelmhalaClothingFacinfoState extends State<readyMadeelmhalaClothingFacinfo> {
  final Stream<QuerySnapshot> obourInfo = FirebaseFirestore.instance
      .collection('مصانع/مصانع ملابس/مصانع ملابس جاهزة المحله الكبري')
      .snapshots();
...
class readyMadeelmhalaClothingFacbanner extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  readyMadeelmhalaClothingFacbanner({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<readyMadeelmhalaClothingFacbanner> createState() => _readyMadeelmhalaClothingFacbannerState();
}

class _readyMadeelmhalaClothingFacbannerState extends State<readyMadeelmhalaClothingFacbanner> {
