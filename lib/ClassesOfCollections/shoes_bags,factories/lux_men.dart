...
class LuxMenShoesBagsFactories extends StatelessWidget {
  LuxMenShoesBagsFactories({super.key});
  final Stream<QuerySnapshot> luxmen = FirebaseFirestore.instance
      .collection('مصانع/مصانع احذية وشنط/مصانع احذية لوكس رجالي')
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('مصانع احذسة لوكس رجالي'),
      ),
      body: Container(
        child: StreamBuilder(
          stream: luxmen,
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(
                          () => luxmenbannersInfo(factoryDatatwo: factoryData));
                    },
                    child: Image.network(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(
                          () => luxmenShoesFacInfo(factoryData: factoryData));
                    },
...
//
class luxmenShoesFacInfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const luxmenShoesFacInfo({Key? key, required this.factoryData});

  @override
  State<luxmenShoesFacInfo> createState() => _luxmenShoesFacInfoState();
}

class _luxmenShoesFacInfoState extends State<luxmenShoesFacInfo> {
  final Stream<QuerySnapshot> luxmenfacinfo = FirebaseFirestore.instance
      .collection('مصانع/مصانع احذية وشنط/مصانع احذية لوكس رجالي')
      .snapshots();
...
class luxmenbannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  luxmenbannersInfo({Key? key, required this.factoryDatatwo}) : super(key: key);

  @override
  State<luxmenbannersInfo> createState() => _luxmenbannersInfoState();
}

class _luxmenbannersInfoState extends State<luxmenbannersInfo> {
