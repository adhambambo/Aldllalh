...
class BagsShoesBagsFactories extends StatelessWidget {
  BagsShoesBagsFactories({super.key});
  final Stream<QuerySnapshot> bagsfac = FirebaseFirestore.instance
      .collection('مصانع/مصانع احذية وشنط/مصانع شنط')
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() =>
                          bagsfacbannersInfo(factoryDatatwo: factoryData));
                    },
                    child: Image.network(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => bagsFacInfo(factoryData: factoryData));
                    },
...
//
class bagsFacInfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const bagsFacInfo({Key? key, required this.factoryData});

  @override
  State<bagsFacInfo> createState() => _bagsFacInfoState();
}

class _bagsFacInfoState extends State<bagsFacInfo> {
  final Stream<QuerySnapshot> bagsInfo = FirebaseFirestore.instance
      .collection('مصانع/مصانع احذية وشنط/مصانع شنط')
      .snapshots();
...
class bagsfacbannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  bagsfacbannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<bagsfacbannersInfo> createState() => _bagsfacbannersInfoState();
}

class _bagsfacbannersInfoState extends State<bagsfacbannersInfo> {
