...
class PopularShoesShoesBagsFactories extends StatelessWidget {
  PopularShoesShoesBagsFactories({super.key});
  final Stream<QuerySnapshot> Popularshoes = FirebaseFirestore.instance
      .collection('مصانع/مصانع احذية وشنط/مصانع احذية شعبي')
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => popularshoesfacbannersInfo(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(
                          () => popularShoesFacInfo(factoryData: factoryData));
                    },
...
//
class popularShoesFacInfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const popularShoesFacInfo({Key? key, required this.factoryData});

  @override
  State<popularShoesFacInfo> createState() => _popularShoesFacInfoState();
}

class _popularShoesFacInfoState extends State<popularShoesFacInfo> {
  final Stream<QuerySnapshot> popularshoesfacinfo = FirebaseFirestore.instance
      .collection('مصانع/مصانع احذية وشنط/مصانع احذية شعبي')
      .snapshots();
...
class popularshoesfacbannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  popularshoesfacbannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<popularshoesfacbannersInfo> createState() =>
      _popularshoesfacbannersInfoState();
}

class _popularshoesfacbannersInfoState
    extends State<popularshoesfacbannersInfo> {
