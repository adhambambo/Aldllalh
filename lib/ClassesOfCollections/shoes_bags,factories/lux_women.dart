...
class LUXWomenShoesBagsFactories extends StatelessWidget {
  LUXWomenShoesBagsFactories({super.key});
  final Stream<QuerySnapshot> luxWomen = FirebaseFirestore.instance
      .collection('مصانع/مصانع احذية وشنط/مصانع احذية لوكس حريمي')
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('مصانع احذية لوكس حريمي'),
      ),
      body: Container(
        child: StreamBuilder(
          stream: luxWomen,
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() =>
                          luxwomenbannersInfo(factoryDatatwo: factoryData));
                    },
                    child: Image.network(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(
                          () => luxwomenShoesFacInfo(factoryData: factoryData));
                    },
...
//
class luxwomenShoesFacInfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const luxwomenShoesFacInfo({Key? key, required this.factoryData});

  @override
  State<luxwomenShoesFacInfo> createState() => _luxwomenShoesFacInfoState();
}

class _luxwomenShoesFacInfoState extends State<luxwomenShoesFacInfo> {
  final Stream<QuerySnapshot> luxwomenshoesfacinfo = FirebaseFirestore.instance
      .collection('مصانع/مصانع احذية وشنط/مصانع احذية لوكس حريمي')
      .snapshots();
   int _current = 0;
     late int viewsCount;
...
class luxwomenbannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  luxwomenbannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<luxwomenbannersInfo> createState() => _luxwomenbannersInfoState();
}

class _luxwomenbannersInfoState extends State<luxwomenbannersInfo> {
