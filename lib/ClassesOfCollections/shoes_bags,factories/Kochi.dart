...
class KochiShoesBagsFactories extends StatelessWidget {
  KochiShoesBagsFactories({super.key});
  final Stream<QuerySnapshot> kochi = FirebaseFirestore.instance
      .collection('مصانع/مصانع احذية وشنط/مصانع احذية كوتشي')
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => KochiShoesFacInfo(factoryData: factoryData));
                    },
                    child: Image.network(
...
//
class KochiShoesFacInfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const KochiShoesFacInfo({Key? key, required this.factoryData});

  @override
  State<KochiShoesFacInfo> createState() => _KochiShoesFacInfoState();
}

class _KochiShoesFacInfoState extends State<KochiShoesFacInfo> {
...
class kochifacbannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  kochifacbannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<kochifacbannersInfo> createState() => _kochifacbannersInfoState();
}

class _kochifacbannersInfoState extends State<kochifacbannersInfo> {
