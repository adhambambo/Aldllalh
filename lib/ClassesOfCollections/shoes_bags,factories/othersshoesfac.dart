...
class othersShoesBagsFactories extends StatelessWidget {
  othersShoesBagsFactories({super.key});
  final Stream<QuerySnapshot> luxWomen = FirebaseFirestore.instance
      .collection('مصانع/مصانع احذية وشنط/مصانع احذية وشنط اخري')
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => othersshoesfacbannersInfo(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => otherShoesFacInfo(factoryData: factoryData));
                    },
...
//
class otherShoesFacInfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const otherShoesFacInfo({Key? key, required this.factoryData});

  @override
  State<otherShoesFacInfo> createState() => _otherShoesFacInfoState();
}

class _otherShoesFacInfoState extends State<otherShoesFacInfo> {
...
class othersshoesfacbannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  othersshoesfacbannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<othersshoesfacbannersInfo> createState() =>
      _othersshoesfacbannersInfoState();
}

class _othersshoesfacbannersInfoState extends State<othersshoesfacbannersInfo> {
