...
class BeltShoesBagsFactories extends StatelessWidget {
  BeltShoesBagsFactories({super.key});
  final Stream<QuerySnapshot> belt = FirebaseFirestore.instance
      .collection('مصانع/مصانع احذية وشنط/مصانع حزام')
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(
                          () => beltbannersInfo(factoryDatatwo: factoryData));
                    },
                    child: Image.network(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => beltFacInfo(factoryData: factoryData));
                    },
...
//
class beltFacInfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const beltFacInfo({Key? key, required this.factoryData});

  @override
  State<beltFacInfo> createState() => _beltFacInfoState();
}

class _beltFacInfoState extends State<beltFacInfo> {
  final Stream<QuerySnapshot> beltFacInfoo = FirebaseFirestore.instance
      .collection('مصانع/مصانع احذية وشنط/مصانع حزام')
      .snapshots();
...
class beltbannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  beltbannersInfo({Key? key, required this.factoryDatatwo}) : super(key: key);

  @override
  State<beltbannersInfo> createState() => _beltbannersInfoState();
}

class _beltbannersInfoState extends State<beltbannersInfo> {
