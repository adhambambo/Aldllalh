...
class BabElsharyeaShoesBagsOffices extends StatelessWidget {
  BabElsharyeaShoesBagsOffices({super.key});
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('مكاتب/مكاتب احذية وشنط/مكاتب احذية وشنط باب الشعرية')
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('مكاتب احذية وشنط باب الشعرية'),
      ),
      body: Container(
        child: StreamBuilder(
          stream: kochiFAcInfo,
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() =>
                          babshaareyabannersInfo(factoryDatatwo: factoryData));
                    },
                    child: Image.network(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => babelshaaryashoesProductionofficeinfo(
...
//
class babelshaaryashoesProductionofficeinfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const babelshaaryashoesProductionofficeinfo(
      {Key? key, required this.factoryData});

  @override
  State<babelshaaryashoesProductionofficeinfo> createState() =>
      _babelshaaryashoesProductionofficeinfoState();
}

class _babelshaaryashoesProductionofficeinfoState
    extends State<babelshaaryashoesProductionofficeinfo> {
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('مكاتب/مكاتب احذية وشنط/مكاتب احذية وشنط باب الشعرية')
      .snapshots();
   int _current = 0;
...
class babshaareyabannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  babshaareyabannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<babshaareyabannersInfo> createState() => _babshaareyabannersInfoState();
}

class _babshaareyabannersInfoState extends State<babshaareyabannersInfo> {
