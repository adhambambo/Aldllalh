...
class NewNozhaShoesBagsOffices extends StatelessWidget {
  NewNozhaShoesBagsOffices({super.key});
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('مكاتب/مكاتب احذية وشنط/مكاتب احذية وشنط النزهة الجديده')
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('مكاتب احذية وشنط النزهة الجديده'),
      ),
      body: Container(
        child: StreamBuilder(
          stream: kochiFAcInfo,
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() =>
                          nozhashoesbannersInfo(factoryDatatwo: factoryData));
                    },
                    child: Image.network(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(
                          () => newnozhaofficeinfo(factoryData: factoryData));
                    },
...
//
class newnozhaofficeinfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const newnozhaofficeinfo({Key? key, required this.factoryData});

  @override
  State<newnozhaofficeinfo> createState() => _newnozhaofficeinfoState();
}

class _newnozhaofficeinfoState extends State<newnozhaofficeinfo> {
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('مكاتب/مكاتب احذية وشنط/مكاتب احذية وشنط النزهة الجديده')
      .snapshots();
...
class nozhashoesbannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  nozhashoesbannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<nozhashoesbannersInfo> createState() => _nozhashoesbannersInfoState();
}

class _nozhashoesbannersInfoState extends State<nozhashoesbannersInfo> {
