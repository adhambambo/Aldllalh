...
class othersShoesBagsOffices extends StatelessWidget {
  othersShoesBagsOffices({super.key});
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('مكاتب/مكاتب احذية وشنط/مكاتب احذية وشنط اخري')
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('مكاتب احذية وشنط اخري '),
      ),
      body: Container(
        child: StreamBuilder(
          stream: kochiFAcInfo,
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => othersshoesofficebannersInfo(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => othersofficeinfo(factoryData: factoryData));
                    },
...
//
class othersofficeinfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const othersofficeinfo({Key? key, required this.factoryData});

  @override
  State<othersofficeinfo> createState() => _othersofficeinfoState();
}

class _othersofficeinfoState extends State<othersofficeinfo> {
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('مكاتب/مكاتب احذية وشنط/مكاتب احذية وشنط اخري')
      .snapshots();
...
class othersshoesofficebannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  othersshoesofficebannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<othersshoesofficebannersInfo> createState() =>
      _othersshoesofficebannersInfoState();
}

class _othersshoesofficebannersInfoState
    extends State<othersshoesofficebannersInfo> {
