...
class AlmoskiClothingProductionSupplies extends StatelessWidget {
  AlmoskiClothingProductionSupplies({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('اكسسوارات ملابس حارة المزين والموسكي'),
      ),
      body: Container(
        child: StreamBuilder(
          stream: kochi,
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => alomoskiaccesoriesbannersInfo(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(() =>
                          AccessoriesclothingMousqy(factoryData: factoryData));
                    },
...
//
class AccessoriesclothingMousqy extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const AccessoriesclothingMousqy({Key? key, required this.factoryData});

  @override
  State<AccessoriesclothingMousqy> createState() =>
      _AccessoriesclothingMousqyState();
}

class _AccessoriesclothingMousqyState extends State<AccessoriesclothingMousqy> {
...
class alomoskiaccesoriesbannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  alomoskiaccesoriesbannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<alomoskiaccesoriesbannersInfo> createState() =>
      _alomoskiaccesoriesbannersInfoState();
}

class _alomoskiaccesoriesbannersInfoState
    extends State<alomoskiaccesoriesbannersInfo> {
