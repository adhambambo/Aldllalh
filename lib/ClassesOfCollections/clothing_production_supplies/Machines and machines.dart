...
class MachineMachinesClothingProductionSupplies extends StatelessWidget {
  MachineMachinesClothingProductionSupplies({super.key});
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('مصانع/مستلزمات انتاج ملابس/مكن والات')
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => nachinemachinesbannersInfo(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => MachineMachineseclothingeiinfo(
...
//
class MachineMachineseclothingeiinfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const MachineMachineseclothingeiinfo({Key? key, required this.factoryData});

  @override
  State<MachineMachineseclothingeiinfo> createState() =>
      _MachineMachineseclothingeiinfoState();
}

class _MachineMachineseclothingeiinfoState
    extends State<MachineMachineseclothingeiinfo> {
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('مصانع/مستلزمات انتاج ملابس/مكن والات')
      .snapshots();
...
class nachinemachinesbannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  nachinemachinesbannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<nachinemachinesbannersInfo> createState() =>
      _nachinemachinesbannersInfoState();
}

class _nachinemachinesbannersInfoState
    extends State<nachinemachinesbannersInfo> {
