...
import '../../Cores/Custom_Colors.dart';

class EghteenStClothingProductionSupplies extends StatelessWidget {
  EghteenStClothingProductionSupplies({super.key});
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('مصانع/مستلزمات انتاج ملابس/اكسسوارات ملابس شارع 18')
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('اكسسوارات ملابس شارع 18'),
      ),
      body: Container(
        child: StreamBuilder(
          stream: kochiFAcInfo,
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => accessorieseighteenstbannersInfo(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => Accessoriesclothingeighteenstinfo(
...
//
class Accessoriesclothingeighteenstinfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const Accessoriesclothingeighteenstinfo(
      {Key? key, required this.factoryData});

  @override
  State<Accessoriesclothingeighteenstinfo> createState() =>
      _AccessoriesclothingeighteenstinfoState();
}

class _AccessoriesclothingeighteenstinfoState
    extends State<Accessoriesclothingeighteenstinfo> {
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('مصانع/مستلزمات انتاج ملابس/اكسسوارات ملابس شارع 18')
      .snapshots();
...
class accessorieseighteenstbannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  accessorieseighteenstbannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<accessorieseighteenstbannersInfo> createState() =>
      _accessorieseighteenstbannersInfoState();
}

class _accessorieseighteenstbannersInfoState
    extends State<accessorieseighteenstbannersInfo> {
