...
class GarageGesrSuezClothingProductionSupplies extends StatelessWidget {
  GarageGesrSuezClothingProductionSupplies({super.key});
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('مصانع/مستلزمات انتاج ملابس/اكسسوارات ملابس الجراج جسرالسويس')
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('اكسسوارات ملابس الجراج جسر السويس'),
      ),
      body: Container(
        child: StreamBuilder(
          stream: kochiFAcInfo,
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => accessoriesgesrsuizbannersInfo(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => Accessoriesclothingeiggesrsuezinfo(
...
//
class Accessoriesclothingeiggesrsuezinfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const Accessoriesclothingeiggesrsuezinfo(
      {Key? key, required this.factoryData});

  @override
  State<Accessoriesclothingeiggesrsuezinfo> createState() =>
      _AccessoriesclothingeiggesrsuezinfoState();
}

class _AccessoriesclothingeiggesrsuezinfoState
    extends State<Accessoriesclothingeiggesrsuezinfo> {
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('مصانع/مستلزمات انتاج ملابس/اكسسوارات ملابس الجراج جسرالسويس')
      .snapshots();
...
class accessoriesgesrsuizbannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  accessoriesgesrsuizbannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<accessoriesgesrsuizbannersInfo> createState() =>
      _accessoriesgesrsuizbannersInfoState();
}

class _accessoriesgesrsuizbannersInfoState
    extends State<accessoriesgesrsuizbannersInfo> {
