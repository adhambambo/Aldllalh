...
class ZippersHangersClothingProductionSupplies extends StatelessWidget {
  ZippersHangersClothingProductionSupplies({super.key});
  final Stream<QuerySnapshot> kochi = FirebaseFirestore.instance
      .collection('مصانع/مستلزمات انتاج ملابس/مصانع سوست وشماعات واكياس')
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('مصانع سوست وشماعات واكياس'),
      ),
      body: Container(
        child: StreamBuilder(
          stream: kochi,
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() =>
                          zippersbannersInfo(factoryDatatwo: factoryData));
                    },
                    child: Image.network(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(() =>
                          zippesHangersBagsFacInfo(factoryData: factoryData));
                    },
...
//
class zippesHangersBagsFacInfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const zippesHangersBagsFacInfo({Key? key, required this.factoryData});

  @override
  State<zippesHangersBagsFacInfo> createState() =>
      _zippesHangersBagsFacInfoState();
}

class _zippesHangersBagsFacInfoState extends State<zippesHangersBagsFacInfo> {
...
class zippersbannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  zippersbannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<zippersbannersInfo> createState() => _zippersbannersInfoState();
}

class _zippersbannersInfoState extends State<zippersbannersInfo> {
