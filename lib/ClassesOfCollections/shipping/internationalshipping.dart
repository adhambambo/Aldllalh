...
class internationalshipping extends StatelessWidget {
  internationalshipping({super.key});
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('شركات شحن/شركات شحن/شركات شحن داخلي ودولي')
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('شركات شحن داخلي ودولي'),
      ),
      body: Container(
        child: StreamBuilder(
          stream: kochiFAcInfo,
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => internationalshiipingbannersInfo(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(() =>
                          internationalshippinginfo(factoryData: factoryData));
                    },
...
//
class internationalshippinginfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const internationalshippinginfo({Key? key, required this.factoryData});

  @override
  State<internationalshippinginfo> createState() =>
      _internationalshippinginfoState();
}

class _internationalshippinginfoState extends State<internationalshippinginfo> {
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('شركات شحن/شركات شحن/شركات شحن داخلي ودولي')
      .snapshots();
...
class internationalshiipingbannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  internationalshiipingbannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<internationalshiipingbannersInfo> createState() =>
      _internationalshiipingbannersInfoState();
}

class _internationalshiipingbannersInfoState
    extends State<internationalshiipingbannersInfo> {
