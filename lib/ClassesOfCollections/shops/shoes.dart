...
class Shoesshops extends StatelessWidget {
  Shoesshops({super.key});
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('محلات/محلات/محلات احذية')
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() =>
                          shoesshopbannersInfo(factoryDatatwo: factoryData));
                    },
                    child: Image.network(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => shoesshopsinfo(factoryData: factoryData));
                    },
...
//
class shoesshopsinfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const shoesshopsinfo({Key? key, required this.factoryData});

  @override
  State<shoesshopsinfo> createState() => _shoesshopsinfoState();
}

class _shoesshopsinfoState extends State<shoesshopsinfo> {
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('محلات/محلات/محلات احذية')
      .snapshots();
...
class shoesshopbannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  shoesshopbannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<shoesshopbannersInfo> createState() => _shoesshopbannersInfoState();
}

class _shoesshopbannersInfoState extends State<shoesshopbannersInfo> {
