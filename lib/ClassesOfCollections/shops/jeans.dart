...
class Jeansshops extends StatelessWidget {
  Jeansshops({super.key});
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('محلات/محلات/محلات جينز')
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() =>
                          jeansshopbannersInfo(factoryDatatwo: factoryData));
                    },
                    child: Image.network(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => jeansshopsinfo(factoryData: factoryData));
                    },
...
//
class jeansshopsinfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const jeansshopsinfo({Key? key, required this.factoryData});

  @override
  State<jeansshopsinfo> createState() => _jeansshopsinfoState();
}

class _jeansshopsinfoState extends State<jeansshopsinfo> {
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('محلات/محلات/محلات جينز')
      .snapshots();
...
class jeansshopbannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  jeansshopbannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<jeansshopbannersInfo> createState() => _jeansshopbannersInfoState();
}

class _jeansshopbannersInfoState extends State<jeansshopbannersInfo> {
