...
class NewNozhaClothingOffices extends StatelessWidget {
  NewNozhaClothingOffices({super.key});
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('مكاتب/مكاتب ملابس/مكاتب ملابس النزهة الجديده')
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('مكاتب ملابس النزهة الجديده '),
      ),
      body: Container(
        child: StreamBuilder(
          stream: kochiFAcInfo,
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => newnpzhapfficebannersInfo(
...
class newnpzhapfficebannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  newnpzhapfficebannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<newnpzhapfficebannersInfo> createState() =>
      _newnpzhapfficebannersInfoState();
}

class _newnpzhapfficebannersInfoState extends State<newnpzhapfficebannersInfo> {
