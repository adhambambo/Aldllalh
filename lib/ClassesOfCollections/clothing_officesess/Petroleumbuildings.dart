...
class PetroliumBuildingClothingOffices extends StatelessWidget {
  PetroliumBuildingClothingOffices({super.key});
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('مكاتب/مكاتب ملابس/مكاتب ملابس عمارات البترول')
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('مكاتب ملابس عمارات البترول'),
      ),
      body: Container(
        child: StreamBuilder(
          stream: kochiFAcInfo,
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => ptroluiumofficebannersInfo(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => petorliumbuildingofficeinfo(
...
//
class petorliumbuildingofficeinfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const petorliumbuildingofficeinfo({Key? key, required this.factoryData});

  @override
  State<petorliumbuildingofficeinfo> createState() =>
      _petorliumbuildingofficeinfoState();
}

class _petorliumbuildingofficeinfoState
    extends State<petorliumbuildingofficeinfo> {
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('مكاتب/مكاتب ملابس/مكاتب ملابس عمارات البترول')
      .snapshots();
...
class ptroluiumofficebannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  ptroluiumofficebannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<ptroluiumofficebannersInfo> createState() =>
      _ptroluiumofficebannersInfoState();
}

class _ptroluiumofficebannersInfoState
    extends State<ptroluiumofficebannersInfo> {
