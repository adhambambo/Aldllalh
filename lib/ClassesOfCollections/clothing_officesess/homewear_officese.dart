...
class HomewearWomensClothingOffices extends StatelessWidget {
  HomewearWomensClothingOffices({super.key});
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('مكاتب/مكاتب ملابس/مكاتب ملابس هوم ويير حريمي')
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('مكاتب ملابس هوم وير حريمي'),
      ),
      body: Container(
        child: StreamBuilder(
          stream: kochiFAcInfo,
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => homewearofficebannersInfo(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => homewearinfoofficeProductioninfo(
...
//
class homewearinfoofficeProductioninfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const homewearinfoofficeProductioninfo({Key? key, required this.factoryData});

  @override
  State<homewearinfoofficeProductioninfo> createState() =>
      _homewearinfoofficeProductioninfoState();
}

class _homewearinfoofficeProductioninfoState
    extends State<homewearinfoofficeProductioninfo> {
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('مكاتب/مكاتب ملابس/مكاتب ملابس هوم ويير حريمي')
      .snapshots();
...
class homewearofficebannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  homewearofficebannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<homewearofficebannersInfo> createState() =>
      _homewearofficebannersInfoState();
}

class _homewearofficebannersInfoState extends State<homewearofficebannersInfo> {
