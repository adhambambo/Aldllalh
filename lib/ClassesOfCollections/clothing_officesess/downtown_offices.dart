...
class DOWNTOWNClothingOffices extends StatelessWidget {
  DOWNTOWNClothingOffices({super.key});
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('مكاتب/مكاتب ملابس/مكاتب ملابس وسط البلد')
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('مكاتب ملابس وسط البلد'),
      ),
      body: Container(
        child: StreamBuilder(
          stream: kochiFAcInfo,
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => downtownofficebannersInfo(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => downtowninfoofficeProductioninfo(
...
//
class downtowninfoofficeProductioninfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const downtowninfoofficeProductioninfo({Key? key, required this.factoryData});

  @override
  State<downtowninfoofficeProductioninfo> createState() =>
      _downtowninfoofficeProductioninfoState();
}

class _downtowninfoofficeProductioninfoState
    extends State<downtowninfoofficeProductioninfo> {
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('مكاتب/مكاتب ملابس/مكاتب ملابس وسط البلد')
      .snapshots();
...
class downtownofficebannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  downtownofficebannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<downtownofficebannersInfo> createState() =>
      _downtownofficebannersInfoState();
}

class _downtownofficebannersInfoState extends State<downtownofficebannersInfo> {
