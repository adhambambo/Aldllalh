...
class RoxyCasualClothingOffices extends StatelessWidget {
  RoxyCasualClothingOffices({super.key});
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('مكاتب/مكاتب ملابس/مكاتب ملابس كاجوال روكسي')
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('مكاتب ملابس كاجوال روكسي'),
      ),
      body: Container(
        child: StreamBuilder(
          stream: kochiFAcInfo,
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => roxycasulaofficebannersInfo(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(
                          () => casualroxyofficeinfo(factoryData: factoryData));
                    },
...
//
class casualroxyofficeinfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const casualroxyofficeinfo({Key? key, required this.factoryData});

  @override
  State<casualroxyofficeinfo> createState() => _casualroxyofficeinfoState();
}

class _casualroxyofficeinfoState extends State<casualroxyofficeinfo> {
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('مكاتب/مكاتب ملابس/مكاتب ملابس كاجوال روكسي')
      .snapshots();
...
class roxycasulaofficebannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  roxycasulaofficebannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<roxycasulaofficebannersInfo> createState() =>
      _roxycasulaofficebannersInfoState();
}

class _roxycasulaofficebannersInfoState
    extends State<roxycasulaofficebannersInfo> {
