...
class YouthMenClothingOffices extends StatelessWidget {
  YouthMenClothingOffices({super.key});
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('مكاتب/مكاتب ملابس/مكاتب ملابس شبابي ورجالي')
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('مكاتب ملابس شبابي ورجالي'),
      ),
      body: Container(
        child: StreamBuilder(
          stream: kochiFAcInfo,
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => youthandmenofficcebannersInfo(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(() =>
                          youthandmenofficeinfo(factoryData: factoryData));
                    },
...
//
class youthandmenofficeinfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const youthandmenofficeinfo({Key? key, required this.factoryData});

  @override
  State<youthandmenofficeinfo> createState() => _youthandmenofficeinfoState();
}

class _youthandmenofficeinfoState extends State<youthandmenofficeinfo> {
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('مكاتب/مكاتب ملابس/مكاتب ملابس شبابي ورجالي')
      .snapshots();
...
class youthandmenofficcebannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  youthandmenofficcebannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<youthandmenofficcebannersInfo> createState() =>
      _youthandmenofficcebannersInfoState();
}

class _youthandmenofficcebannersInfoState
    extends State<youthandmenofficcebannersInfo> {
