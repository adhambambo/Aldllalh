...
class othersClothingOffices extends StatelessWidget {
  othersClothingOffices({super.key});
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('مكاتب/مكاتب ملابس/مكاتب ملابس اخري')
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() =>
                          othersofficebannersInfo(factoryDatatwo: factoryData));
                    },
                    child: Image.network(
...
class othersofficebannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  othersofficebannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<othersofficebannersInfo> createState() =>
      _othersofficebannersInfoState();
}

class _othersofficebannersInfoState extends State<othersofficebannersInfo> {
