...
class CasualWomensClothingOffices extends StatelessWidget {
  CasualWomensClothingOffices({super.key});
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('مكاتب/مكاتب ملابس/مكاتب ملابس كاجوال حريمي')
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('مكاتب ملابس كاجوال حريمي'),
      ),
      body: Container(
        child: StreamBuilder(
          stream: kochiFAcInfo,
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => casulawomensofficebannersInfo(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => casualwomensofficeProductioninfo(
...
//
class casualwomensofficeProductioninfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const casualwomensofficeProductioninfo({Key? key, required this.factoryData});

  @override
  State<casualwomensofficeProductioninfo> createState() =>
      _casualwomensofficeProductioninfoState();
}

class _casualwomensofficeProductioninfoState
    extends State<casualwomensofficeProductioninfo> {
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('مكاتب/مكاتب ملابس/مكاتب ملابس كاجوال حريمي')
      .snapshots();
...
class casulawomensofficebannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  casulawomensofficebannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<casulawomensofficebannersInfo> createState() =>
      _casulawomensofficebannersInfoState();
}

class _casulawomensofficebannersInfoState
    extends State<casulawomensofficebannersInfo> {
