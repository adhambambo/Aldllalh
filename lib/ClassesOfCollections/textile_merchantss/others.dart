...
class OTHERSTextileMerchants extends StatelessWidget {
  OTHERSTextileMerchants({super.key});
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('مكاتب/تجار اقمشة/تجار اقمشة اخري')
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => otherstextilebannersInfo(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(
                          () => OTHERSmerchantsinfo(factoryData: factoryData));
                    },
...
//
class OTHERSmerchantsinfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const OTHERSmerchantsinfo({Key? key, required this.factoryData});

  @override
  State<OTHERSmerchantsinfo> createState() => _OTHERSmerchantsinfoState();
}

class _OTHERSmerchantsinfoState extends State<OTHERSmerchantsinfo> {
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('مكاتب/تجار اقمشة/تجار اقمشة اخري')
      .snapshots();
...
class otherstextilebannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  otherstextilebannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<otherstextilebannersInfo> createState() =>
      _otherstextilebannersInfoState();
}

class _otherstextilebannersInfoState extends State<otherstextilebannersInfo> {
