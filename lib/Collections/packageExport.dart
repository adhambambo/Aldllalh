...
class PackageExports extends StatelessWidget {
  PackageExports({super.key});
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('كولكشن/كولكشن/استوك وبواقي تصدير')
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('استوك و بواقي تصدير'),
      ),
      body: Container(
        child: StreamBuilder(
          stream: kochiFAcInfo,
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => packageexportbannersInfo(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => PackageExportscollecyioninfo(
...
//
class PackageExportscollecyioninfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const PackageExportscollecyioninfo({Key? key, required this.factoryData});

  @override
  State<PackageExportscollecyioninfo> createState() =>
      _PackageExportscollecyioninfoState();
}

class _PackageExportscollecyioninfoState
    extends State<PackageExportscollecyioninfo> {
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('كولكشن/كولكشن/استوك وبواقي تصدير')
      .snapshots();
...
class packageexportbannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  packageexportbannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<packageexportbannersInfo> createState() =>
      _packageexportbannersInfoState();
}

class _packageexportbannersInfoState extends State<packageexportbannersInfo> {
