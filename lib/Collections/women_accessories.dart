...
class WomesAccessories extends StatelessWidget {
  WomesAccessories({super.key});
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('كولكشن/كولكشن/اكسسوارات حريمي')
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() =>
                          womenaccbannersInfo(factoryDatatwo: factoryData));
                    },
                    child: Image.network(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => womenaccinfo(factoryData: factoryData));
                    },
...
//
class womenaccinfo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const womenaccinfo({Key? key, required this.factoryData});

  @override
  State<womenaccinfo> createState() => _womenaccinfoState();
}

class _womenaccinfoState extends State<womenaccinfo> {
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('كولكشن/كولكشن/اكسسوارات حريمي')
      .snapshots();
...
class womenaccbannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  womenaccbannersInfo({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<womenaccbannersInfo> createState() => _womenaccbannersInfoState();
}

class _womenaccbannersInfoState extends State<womenaccbannersInfo> {
