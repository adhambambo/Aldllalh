...
class _toysState extends State<toys> {
  final Stream<QuerySnapshot> AbayatKerdasa = FirebaseFirestore.instance
      .collection('كولكشن/كولكشن/العاب اطفال')
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(
                          () => toysbannersInfo(factoryDatatwo: factoryData));
                    },
                    child: Image.network(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(() => toysinfoo(factoryData: factoryData));
                    },
...
//
class toysinfoo extends StatefulWidget {
  final Map<String, dynamic> factoryData;

  const toysinfoo({Key? key, required this.factoryData});

  @override
  State<toysinfoo> createState() => _toysinfooState();
}

class _toysinfooState extends State<toysinfoo> {
...
class toysbannersInfo extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  toysbannersInfo({Key? key, required this.factoryDatatwo}) : super(key: key);

  @override
  State<toysbannersInfo> createState() => _toysbannersInfoState();
}

class _toysbannersInfoState extends State<toysbannersInfo> {
