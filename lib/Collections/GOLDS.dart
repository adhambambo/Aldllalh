...
class Gold extends StatelessWidget {
  ...
  final Stream<QuerySnapshot> kochiFAcInfo = FirebaseFirestore.instance
      .collection('كولكشن/كولكشن/مجوهرات ودهب صيني')
              ...
              itemBuilder: (context, index) {
                ...
                if (factoryData.containsKey('banner')) {
                  return GestureDetector(
                    onTap: () {
                      Get.to(() =>
                          goldbanner(factoryDatatwo: factoryData));
                    },
                    child: Image.network(
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(() =>
                          goldinfo(factoryData: factoryData));
                    },
...
class goldinfo extends StatefulWidget {
  ...
  const goldinfo({Key? key, required this.factoryData});

  @override
  State<goldinfo> createState() =>
      _goldinfoState();
}
...
class goldbanner extends StatefulWidget {
  final Map<String, dynamic> factoryDatatwo;

  goldbanner({Key? key, required this.factoryDatatwo})
      : super(key: key);

  @override
  State<goldbanner> createState() => _goldbannerState();
}

class _goldbannerState extends State<goldbanner> {
